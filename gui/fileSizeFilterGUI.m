...
varargout{1} = get(handles.checkbox_MAX, 'Value');
varargout{2} = get(handles.checkbox_MIN, 'Value');

varargout{3} = (varargout{1}|varargout{2});

varargout{4} = get(handles.edit_MAX, 'String');
varargout{5} = get(handles.edit_MIN, 'String');
