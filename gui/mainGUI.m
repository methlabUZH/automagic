    ...
    if(exist('self', 'var') && isdir(data_path))
        ...
        if( ~ isKey(handles.projectList, name))
            ...
            popup_msg(['This project already exists. You can not ',...
                ...
                'access the existing project anymore: 1. create a copy ' ...
                'of the results folder (including the state.mat file). ' ...
                '2. Remove this project here from the GUI ' ...
                '3. Load a new project using the file path of the new copy you just made'], 'Error');
        end
...
choice = MFquestdlg([main_pos(3)/2/screen_size(3) main_pos(4)/2/screen_size(4)],...
    ...
    'If the the path to Results folder has changed, you can delete this project and ' ...
    'simply load it from the new file path'], ...
    'Take responsibility!',...
