classdef PreprocessingConstants
    ...
    properties(Constant)
        ...
        BidsToolsCsts = struct('URL', 'https://github.com/sccn/bids-matlab-tools/archive/refs/heads/master.zip', ...
                  'ZIP', 'bids-matlab-tools-master.zip');  
              
        BrainVisionCsts = struct('URL', 'https://github.com/arnodelorme/bva-io/archive/refs/heads/master.zip', ...
                   'ZIP', 'bva-io-master.zip');
