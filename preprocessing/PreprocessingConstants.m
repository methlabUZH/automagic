classdef PreprocessingConstants
    ...
    properties(Constant)
        ...
        CRDCsts = struct('CRD_URL', 'http://sccn.ucsd.edu/eeglab/plugins/clean_rawdata0.32.zip', ...
                         'RUN_MESSAGE', 'Finding bad channels...');
                           
        PrepCsts = struct('PREP_URL', 'https://github.com/VisLab/EEG-Clean-Tools/archive/master.zip')
        
        RPCACsts = struct(...
            'RPCA_URL', 'http://perception.csl.illinois.edu/matrix-rank/Files/inexact_alm_rpca.zip', ...
