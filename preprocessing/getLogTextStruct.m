...
log = struct('prep', struct('desc', 'PREP pipeline (Bigdely-Shamlo N, Mullen T, Kothe C, Su K-M and Robbins KA (2015))\n', ...
             ...
             'clean_rawdata', struct('desc', 'clean_rawdata() 0.34 (by Christian Kothe http://sccn.ucsd.edu/wiki/Plugin_list_process)\n', ...
                                     'noASRFilter', 'Temporary (not affecting final data) detrend data with a high pass filter (forward-backward (non-causal) filter) with a transition band of %.2f (stop-band attenuation of 80*dB)\n', ...
                                     'ASRFilter', 'Detrend data (affecting final data) with a high pass filter (forward-backward (non-causal)  filter) with a transition band of %.2f (stop-band attenuation of 80*dB)\n', ...
             ...
             'filtering', struct('desc', 'pop_eegfiltnew() of EEGLAB (Widmann A, Schröger E. Filter effects and filter artifacts in the analysis of electrophysiological data. Frontiers in psychology. 2012 Jul;3:233)\n', ...
              ...
              'badchans', struct('desc', 'Removing a total of %d noisy or outlier channels\n', ...
               ...
               'pca', struct('desc', 'Remove DC offset by subtracting the channel mean\n',...
                             'params', 'The weight on sparse error term in the cost function is 1 / sqrt(numChans) or if not default  %.2f with a tolerance %.2f of for stopping criterion and a maximum number of %d iterations'...
                        ),...
               ...
               'quality', struct('desc', 'Calculate quality measures with Overall thresholds of %.2f, time thresholds of %.2f, channel thresholds of %.2f\n' ...
                             )...
                    );
