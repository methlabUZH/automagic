            ...
            'prep', struct('desc', '* PREP pipeline (Bigdely-Shamlo N, Mullen T, Kothe C, Su K-M and Robbins KA (2015))\n', ...
             ...
             'filtering', struct('desc', '* pop_eegfiltnew() of EEGLAB (Widmann A, Schröger E. Filter effects and filter \n\t artifacts in the analysis of electrophysiological data. Frontiers in \n\t psychology. 2012 Jul;3:233)\n', ...
              ...
              'badchans', struct('desc', '* Removing a total of %d noisy or outlier channels\n', ...
               ...
               'quality', struct('OHA', ['* Selected Overall Quality (OHV) Thresholds of %s \n',...
                                 '* Calculated Overall (OHV) quality Scores for selected thresholds of %s \n',...
                                 '* Comitted (OVH) Quality Threshold [ %s]\n',...
                                 '* Comitted OHV score [ %s]\n',...
                                 '* Comitted OHV Goodcutoff [] \n',...
                                 '* Comitted OHV Badcutoff [] \n\n'],...
                                 'THV',['* Selected Timepoints of High Variance (OHV) Thresholds of %s \n',...
                                 '* Calculated Overall (THV) quality Scores for selected thresholds of %s \n',...
                                 '* Comitted (THV) Quality Threshold [ %s]\n',...
                                 '* Comitted THV score [ %s]\n',...
                                 '* Comitted THV Goodcutoff [] \n',...
                                 '* Comitted THV Badcutoff [] \n\n'],...
                                 'CHV',['* Selected  Channels of High Variance (CHV) Thresholds of %s \n',...
                                 '* Calculated Overall (CHV) quality Scores for selected thresholds of %s \n',...
                                 '* Comitted (CHV) Quality Threshold [ %s]\n',...
                                 '* Comitted CHV score [ %s]\n',...
                                 '* Comitted CHV Goodcutoff [] \n',...
                                 '* Comitted CHV Badcutoff [] \n\n'],...
                                 'RBC', ['* RBC \n',...
                                 '* Calculated RBC quality measure \n',...
                                 '* Comitted RBC Goodcutoff [] \n',...
                                 '* Comitted RBC Badcutoff [] \n\n']...
                                 ));
end