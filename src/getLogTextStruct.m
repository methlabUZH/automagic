...
log = struct('info', struct('automagic', 'Automagic version %s\n',...
            ...
            'prep', struct('desc', '* PREP pipeline (Bigdely-Shamlo N, Mullen T, Kothe C, Su K-M and Robbins KA (2015))\n', ...
             ...
             'clean_rawdata', struct('desc', '* clean_rawdata() 0.34 (by Christian Kothe http://sccn.ucsd.edu/wiki/Plugin_list_process)\n', ...
                                     ...
                                     'flatLine', '\t* Detecting (near-) flat-lined channels with a maximally tolerated duration of %.2f s and a maximum tolerated jitter during flatlines of 20x epsilon (i.e. floating-point relative accuracy).\n', ...
                                     ...
                                     'ransac', '\t* Detecting noisy or outlier channels based on lack of predictability by other channels using a RANSAC sample size of 50 in a fraction of 0.25 evaluation channels to predict a channel. Channels are bad if the RANSAC prediction in a fraction of %.2f windows of 5* s duration falls below the absolute correlation of %.2f.\n', ...
